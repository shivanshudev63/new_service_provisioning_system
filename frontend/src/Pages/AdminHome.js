...
//   useEffect(() => {
//     // Fetch customers
//     axios.get('http://54.175.148.241:8081/customers')
//       .then(res => {
...
//     axios.get('http://54.175.148.241:8081/requests')
//       .then(res => {
//         if (Array.isArray(res.data)) {
...
//     axios.get(`http://54.175.148.241:8081/customer/${id}`)
//       .then(res => {
//         if (res.data) {
...
//     axios.delete(`http://54.175.148.241:8081/customer/${id}`)
//       .then(res => {
...
//     axios.post(`http://54.175.148.241:8081/approve-request/${id}`)
//       .then(res => {
//         if (res.data.Status === "Success") {
...
//     axios.delete(`http://54.175.148.241:8081/requests/${id}`)
//       .then(res => {
