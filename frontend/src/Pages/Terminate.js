...
const Terminate = () => {
  ...
  const handleTerminate = () => {
    ...
    axios.post('http://54.175.148.241:8081/requests', terminationRequest)
    .then(res => {
    ...
    // axios.post('http://54.175.148.241:8081/archive', {
    //   customer_id: customer_id,
    //   service_id: serviceToTerminate.service_id // Use correct field for service ID
    // })
    // .then(() => {
    //   axios.delete(`http://54.175.148.241:8081/customer-services/${selectedService}`)
    //     .then(res => {
