...
const AvailableServices = () => {
    ...
    useEffect(() => {
        const fetchServices = async () => {
            try {
                const response = await axios.get('http://54.175.148.241:8081/getservices');
    ...
    const handleUpdateService = async (id) => {
        try {
            ...
            const response = await axios.put(`http://54.175.148.241:8081/updateservice/${id}`, requestData);
            setShowModal(false);
            console.log('Update response:', response.data);
            alert('Service plans updated successfully');

            const refreshResponse = await axios.get('http://54.175.148.241:8081/getservices');
    ...
    const handleDeleteService = async (id) => {
        ...
        try {
            await axios.delete(`http://54.175.148.241:8081/deleteservice/${id}`);
            const response = await axios.get('http://54.175.148.241:8081/getservices');
            setServices(response.data);
        } catch (error) {
